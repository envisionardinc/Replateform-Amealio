...
- Amealio promotions / modern engine: [domains/101-AMEALIO-PROMOTIONS-TARGET-BEHAVIOR-CONTRACT.md](./domains/101-AMEALIO-PROMOTIONS-TARGET-BEHAVIOR-CONTRACT.md) — **ARCHITECTURE ONLY**
