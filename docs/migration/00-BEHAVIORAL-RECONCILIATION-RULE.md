...
- Consumer offers / coupons browse: [domains/99-CONSUMER-OFFERS-COUPONS-TARGET-BEHAVIOR-CONTRACT.md](./domains/99-CONSUMER-OFFERS-COUPONS-TARGET-BEHAVIOR-CONTRACT.md) — **DEFER — TARGET DEPENDENCY**
