...
| Home 1 taxonomy               | Moods/cravings/curations  | Editorial rails | Canonical restaurants + **Category** rail (doc 94). Moods/cravings/curations stay FUTURE | **PRESERVE** / **IMPROVE** Category HTTP   |
...
| ------ | --------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------- |
| GET    | `/api/v1/discover/home`                 | Public | Canonical feed `{ source: 'CANONICAL', taxonomy, sections }`; optional `city`, `q`, `categoryId` (doc 94) |
| GET    | `/api/v1/discover/restaurants`          | Public | ACTIVE, not deleted; optional `city`, `q`, `categoryId`                                                   |
...
5. **Default home = taxonomy rails vs restaurant grid vs V2 chat** — Home 1 is the canonical restaurant list plus Category chips (doc 94). Moods/cravings/curations and V2 chat remain FUTURE.
...
| `user-moods` / cravings / curations HTTP on Nest | Missing — FUTURE. Category rail ships in doc 94 |
